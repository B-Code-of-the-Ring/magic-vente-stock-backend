package com.gondorchic.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.gondorchic.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.gondorchic.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
