...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUITJOUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUITJOUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUITJOUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUITJOUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUITJOUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUITJOUR actions', async () => {
      const arg = 42666;
